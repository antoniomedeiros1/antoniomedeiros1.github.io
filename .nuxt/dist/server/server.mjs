...
const lightmode = __vite_ssr_import_4__.ref(false)
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))}><div class="dark:bg-slate-800 min-h-screen pb-10"><div class="max-w-7xl mx-auto px-10">`)
