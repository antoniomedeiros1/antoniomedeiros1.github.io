...
const __returned__ = { lightmode, changeMode }
Object.defineProperty(__returned__, '__isScriptSetup', { enumerable: false, value: true })
return __returned__
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<nav${__vite_ssr_import_4__.ssrRenderAttrs(__vite_ssr_import_3__.mergeProps({ class: "flex flex-row justify-between py-3 border-b" }, _attrs))}><div class="flex p-2 ml-2 border border-gray-400 hover:border-gray-800 text-gray-400 hover:text-gray-800 rounded-full hover:cursor-pointer">`)
  if ($setup.lightmode) {
